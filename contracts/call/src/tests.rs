...
use cosmwasm_std::{
    ...
    Empty, MessageInfo, OwnedDeps, StdError, Uint128,
};
...
fn proper_initialization() {
    ...
    assert_eq!(config.min_bid_inc_bips, Uint128::new(1));
...
fn mint_with_nft() {
    ...
    let nft = cw721_base::Cw721Contract::<Empty, Empty, Empty, Empty>::default();
    let res = nft.mint(
        deps.as_mut(),
        info,
        "token_id".to_string(),
